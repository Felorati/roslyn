...
namespace STMExtension
{
    ...
    {
        internal static readonly DiagnosticDescriptor DD_INVALID_RETRY_PLACEMENT = new DiagnosticDescriptor("RetryPlacement", "Invalid retry statement placement", "The retry statement can only be used inside atomic or orelse statements", "Typing", DiagnosticSeverity.Warning, true);
